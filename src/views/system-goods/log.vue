...
<!--        <el-button type="primary" @click="handleCreate" icon="el-icon-plus" v-waves>添加</el-button>-->
      ...
      width="55">
          ...
          <el-table-column label="ID" prop="logId" align="center"></el-table-column>
          <el-table-column label="操作人" prop="logOperationUserName" align="center"></el-table-column>
          <el-table-column label="日志操作描述" prop="logOperation" align="center"></el-table-column>
          <el-table-column label="日志操作时间" prop="logTime" align="center"></el-table-column>
          <el-table-column label="日志操作方法" prop="logMethod" align="center"></el-table-column>
          <el-table-column label="日志操作方法参数" prop="logParams" align="center">
             <template slot-scope="scope">
        <el-popover trigger="hover" placement="top">
         {{ scope.row.logParams }}
          <div slot="reference" class="name-wrapper">
            <el-tag size="medium">{{ scope.row.logParams }}</el-tag>
          </div>
        </el-popover>
      </template>
          </el-table-column>
          <el-table-column label="日志操作IP" prop="logIp" align="center"></el-table-column>
          <el-table-column label="日志操作地点" prop="logLocation" align="center"></el-table-column>
          <el-table-column label="访问时间" align="center">
            <template slot-scope="scope">
              <span>{{scope.row.logCreateTime|dateTimeFilter}}</span>
            </template>
          </el-table-column>
